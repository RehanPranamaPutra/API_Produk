package com.rehan.api_produk.adapter
...
import com.rehan.api_produk.DetailProdukActivity
import com.rehan.api_produk.ModelProduk
import com.rehan.api_produk.R
...
class ProdukAdapter(
    ...
    class ProdukViewHolder (itemView : View, val onClick : (ModelProduk) -> Unit) :
        ...
        RecyclerView.ViewHolder(itemView){
            ...
            val cardDetail : CardView = itemView.findViewById(R.id.cardProduk)
